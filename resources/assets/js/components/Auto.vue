          ...
          <div class="form-group row">
            <div class="col-md-6">
              <div class="input-group">
                ...
                <button
                  type="submit"
                  @click="listarAutoActualizar(1,buscar,criterio,this.sede)"
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                ...
                <td><h6>{{categoria.nombre_completo}}</h6></td>
...
export default {
  ...
  methods: {
    ...
    async listarAuto(page, buscar, criterio) {
  ...
  const { value: fruit } = await this.$swal.fire({
    ...
    listarAutoActualizar(page, buscar, criterio,sede) {
      let me = this;
      var url =
        this.ruta +
        "/listarPruebas?page=" +
