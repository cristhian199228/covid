      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-md-6">
              <div class="input-group">
                ...
                <button
                  type="submit"
                  @click="listarAuto(1,buscar,criterio,id_estacion)"
                ...
                <button
                  type="submit"
                  @click="listarAutoActualizar(1,buscar,criterio,id_estacion)"
                  class="btn btn-info ml-8"
                >
          ...
          <table class="table table-bordered table-striped table-sm">
            ...
            <tbody>
              <tr v-for="categoria in arrayCategoria" :key="categoria.id_ficha_paciente">
                <td>{{categoria.contador}}</td>
                <td>
                  <h6>{{categoria.nombre_completo}}</h6>
                </td>
                ...
                <template v-if="categoria.pruebaSerologica === 'SI'">
                  <td class="bg-danger" v-text="categoria.pruebaSerologica"></td>
                </template>
                <template v-else-if="categoria.pruebaSerologica === 'NO'">
                  <td class="bg-success" v-text="categoria.pruebaSerologica"></td>
                </template>
                <template v-else>
                  <td></td>
                </template>
