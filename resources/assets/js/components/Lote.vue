                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    ...
                                    <td v-text="categoria.sectors_desc"></td>
                                    <td v-text="categoria.manzana_desc"></td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de la Ubicacion">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                       <v-select  v-model="idsede" :options="arraySede"  label="descripcion" ></v-select>                                      
                                    </div>
                                </div>
                                <!--<div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Lote(*)</label>
    ...
    export default {
        ...
        methods : {
            listarLote (page,buscar,criterio){
                let me=this;
                var url=this.ruta + '/lote?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            cargarPdf(){
                window.open(this.ruta + '/lote/excel','_blank');
            },
            ...
            registrarLote(){
                ...
                */
                ...
                axios.post(this.ruta + '/lote/registrar',{
                    'nombre': this.nombre,
                    'descripcion': this.descripcion,
                    'idmanzana': this.idsede.id
            ...
            actualizarCategoria(){
                ...
                */
                ...
                let me = this;
                console.log('sede es'+ this.idsede.id);
                axios.put(this.ruta + '/lote/actualizar',{
            ...
            desactivarCategoria(id){
                console.log(id);
               swal({
                title: 'Esta seguro de desactivar este lote?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta + '/lote/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarLote(1,'','nombre');
                        swal(
            ...
            activarCategoria(id){
               swal({
                title: 'Esta seguro de activar este Lote?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta + '/lote/activar',{
                        'id': id
                    }).then(function (response) {
                        me.listarLote(1,'','nombre');
                        swal(
                    ...
                    case "categoria":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                                ...
                                this.idproyecto = data['sectors_desc'];
                                //this.manzanadesc = data['manzana_desc'];                                
                                this.idsede = data['manzana_desc'];
                                this.nombre = data['descripcion'];
                                this.descripcion= data['comentario'];
                                break;
                            }
                        }
                    }
