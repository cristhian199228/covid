                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    ...
                                    <!--<td v-text="articulo.cat_desc"></td>-->
                                    <td v-text="articulo.marca_desc"></td>
                                   <!-- 
                                   Este valor se omite porque no se contabilizara costos
                                   <td v-text="articulo.precio_venta"></td> 
                                   -->
                                    <!--<td v-text="articulo.mod_desc"></td>-->
                                    <td v-text="articulo.nro_serie"></td> 
                                    <!--<td v-text="articulo.nro_certificado"></td>-->
                                    <td v-text="articulo.sede_desc"></td>
                                    <td v-text="articulo.ubi_desc"></td>
                                    <!--<td v-text="articulo.propietario"></td>-->
                                    <td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Nombre del Cliente(*)</label>
                                    <div class="col-md-9">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                    <input type="text" v-model="nro_serie" class="form-control" placeholder="N° de DNI">                                         
                                    </div>
                                </div>
                                <!--<div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Categoría (*)</label>
                                    <div class="col-md-9">
                                       <v-select v-model="idcategoria" :options="arrayCategoria" @input="getStates(idcategoria)"  label="nombre"></v-select>                                      
                                    </div>
                                </div>
                                -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                       <v-select v-model="idproyecto" :options="arrayProyecto"  label="descripcion" @input="selectSede(idproyecto)"></v-select>                                      
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Lote(*)</label>
                                    <div class="col-md-9">
                                        <v-select v-model="idsede" :options="arraySede"  label="descripcion" @input="selectUbicacion(idsede)"></v-select>                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Departamento (*)</label>
                                    <div class="col-md-9">
                                        <v-select v-model="idubicacion" :options="arrayUbicacion"  label="nombre" ></v-select>                                        
                                    </div>
                                </div>
                                ...
                                -->
                                 <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">Auto</label>
                                     <div class="col-md-9">
                                        <v-select v-model="idmarca" :options="arrayMarca"  label="descripcion" @input="selectModelo(idmarca)"></v-select>                                        
                                    </div>
                                </div>
                                <!--
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <v-select v-model="idmodelo" :options="arrayModelo"  label="descripcion"></v-select>                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">N° Certificado</label>
                                    <div class="col-md-9">
                                        <input type="email" v-model="nro_certificado" class="form-control" placeholder="Ingrese N° Certificado">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="propietario">
                                            ...
                                            <option value="SERMEDI" >SERMEDI</option>
                                        </select>                                        
                                    </div>
                                </div>
                                -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="descripcion" class="form-control" placeholder="Ingrese comentario">
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            selectProyecto(){
                let me=this;
                var url= this.ruta + '/articulo/selectProyecto';
                axios.get(url).then(function (response) {
                    console.log(response);
                    var respuesta= response.data;
            ...
            selectSede(proyecto){
                let me=this;
                console.log('es'+me.idproyecto);
                var url= this.ruta + '/articulo/selectSede/'+proyecto.id;
                axios.get(url).then(function (response) {
                    //console.log(response);
                    var respuesta= response.data;
            ...
            selectUbicacion(sede){
                let me=this;
                var url= this.ruta + '/articulo/selectUbicacion/'+sede.id;
                axios.get(url).then(function (response) {
                    console.log(response);
                    var respuesta= response.data;
                    me.arrayUbicacion= respuesta.ubicacion;
            ...
            selectMarca(){
                let me=this;
                var url= this.ruta + '/articulo/selectMarca/';
                axios.get(url).then(function (response) {
                    console.log(response);
                    var respuesta= response.data;
            ...
            selectModelo(marca){
                this.idmodelo = 0;
                let me=this;
                var url= this.ruta + '/articulo/selectModelo/'+marca.id;
                axios.get(url).then(function (response) {
                    console.log(response);
                    var respuesta= response.data;
            ...
            registrarArticulo(){
                ...
                */
                ...
                axios.post(this.ruta + '/articulo/registrar',{
                    'idcategoria': this.idcategoria.id,
                    'idubicacion': this.idubicacion.id,
                    'codigo': this.codigo,
                    'nombre': this.nombre,
                    'nro_serie': this.nro_serie,
                    'nro_certificado': this.nro_certificado,
                    'propietario': this.propietario,
                    'idmodelo': this.idmodelo.id,
