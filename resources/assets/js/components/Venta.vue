            ...
            <div class="col-md-6">
              <div class="input-group">
                <select class="form-control col-md-3" v-model="criterio">
                  ...
                  <option value="nro_registro">REGISTRO</option>
                </select>
                <input
                  type="text"
                  v-model="buscar"
          ...
          <table class="table w-auto text-xsmall">
            <thead>
              <tr>
                ...
                <th>Ant.Epidemiologicos</th>
                <th>Temperatura</th>
                <th>Prueba Serologica</th>
            ...
            <tbody>
              <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                ...
                <template v-if="categoria.antecedentes_ep === 'SI'">
                  <td class="bg-danger" v-text="categoria.antecedentes_ep"></td>
                </template>
                <template v-else-if="categoria.antecedentes_ep === 'NO'">
                  <td class="bg-success" v-text="categoria.antecedentes_ep"></td>
                </template>
                <template v-else>
                  <td class="bg-success" >NO</td>
                </template>
                ...
                <template v-else>
                  <td v-text="categoria.pruebaSerologica"></td>
                </template>
...
export default {
  ...
  methods: {
    ...
    cargarPdf() {
      window.open(this.ruta + "/examenes/excel", "_blank");
    },
