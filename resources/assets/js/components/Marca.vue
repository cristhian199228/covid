                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                      ...
                                      <option value="comentario">Color</option>
                                    </select>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    <td>
                                        <button type="button" title="Descargar XML" @click="DescargarXML(categoria)" class="btn btn-warning btn-sm">
                                          <i class="icon-cloud-download"></i>
                                        </button> &nbsp;
                                        
                                      
                                        <template v-if="categoria.estado">
                                          <button type="button" title="Ver PDF" @click="DescargarPDF(categoria)" class="btn btn-success btn-sm">
                                          <i class="icon-eye"></i>
                                        </button> &nbsp; 
                                        </template>
                                        ...
                                        <input  id="fileUpload" type="file" v-on:change="CambioArchivo" hidden>
                                        <button type="button"  title="Adjuntar PDF" class="btn btn-info btn-sm" @click="chooseFiles(categoria)">
