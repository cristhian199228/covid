                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    ...
                                    <td v-text="categoria.proy_desc"></td>
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idproyecto">
    ...
    export default {
        ...
        methods : {
            listarCategoria (page,buscar,criterio){
                let me=this;
                var url=this.ruta + '/sede?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarModelo(){
                ...
                */
                ...
                axios.post(this.ruta + '/sede/registrar',{
            ...
            actualizarSede(){
                ...
                */
                ...
                axios.put(this.ruta + '/sede/actualizar',{
                    'descripcion': this.descripcion,
                    'comentario': this.comentario,
            ...
            validarMarca(){
             ...
             selectProyecto(){
                let me=this;
                var url= this.ruta + '/sede/selectProyecto';
                axios.get(url).then(function (response) {
                    console.log(response);
                    var respuesta= response.data;
                    me.arrayMarca= respuesta.proyectos;
                })
                .catch(function (error) {
                    console.log(error);
                });
