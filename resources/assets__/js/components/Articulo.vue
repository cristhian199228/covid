                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">N° Serie (*)</label>
                                    <div class="col-md-9">
                                    <input type="text" v-model="nro_serie" class="form-control" placeholder="N° de Serie">                                         
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <v-select v-model="idubicacion" :options="arrayUbicacion"  label="descripcion" ></v-select>                                        
                                    </div>
                                </div>
