    ...
    export default {
        ...
        methods : {
            listarCategoria (page,buscar,criterio){
                let me=this;
                var url=this.ruta + '/proyecto?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            registrarModelo(){
                ...
                */
                ...
                axios.post(this.ruta + '/modelo/registrar',{
            ...
            actualizarMarca(){
                ...
                */
                ...
                axios.put(this.ruta + '/modelo/actualizar',{
                    'descripcion': this.descripcion,
                    'comentario': this.comentario,
            ...
            desactivarModelo(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta + '/modelo/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCategoria(1,'','descripcion');
                        swal(
            ...
            activarModelo(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put(this.ruta + '/modelo/activar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCategoria(1,'','descripcion');
                        swal(
