...
class ModeloController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($buscar==''){
            $categorias = Modelo::select('modelos.id','modelos.descripcion as moddesc', 'modelos.comentario', 'modelos.condicion', 'marcas.descripcion as marcdesc', 'modelos.id_marca')
